...
function Search() {
    ...
    const summarise = (data: Data) => {
        ...
        fetch(apiUrl, {
            ...
            .then((responseData) => {
                if (responseData.summary === "I apologize, but I'm unable to understand the context you provided. Can you please provide more information or ask a specific question?") {
